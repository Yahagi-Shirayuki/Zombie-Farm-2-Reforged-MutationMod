...
import {
  ...
  mutationBonus, mutationLabel, statEffectsOf, type MutationDef, type Slot,
} from "../zombie/mutations";
import { maskHas, maskUnion, maskWithout } from "../zombie/mutationMask";
import { MUTATION_VARIANTS, } from "../zombie/mutationDisplay";
...
const SLOT_LABEL: Record<Slot, string> = {
  head: "Head", hair_eye: "Hair / Eyes", arm: "Arms", armB: "Second Arm",
  body: "Body", neck: "Neck",
};
...
function renderStatus() {
  ...
  const label = mutationLabel(mask) || "none";
