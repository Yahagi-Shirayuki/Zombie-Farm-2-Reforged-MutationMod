...
const SAMPLES: Record<GameplayCommand["type"], GameplayCommand> = {
  ...
  "powder.grind_start": { type: "powder.grind_start", machineId: "pm-1", crystals: { red: 2, blue: 1 } },
  "powder.grind_collect": { type: "powder.grind_collect", machineId: "pm-1" },
  "roster.dye_start": {
    type: "roster.dye_start", bucketId: "bucket-1", unitId: "z-1", powderColor: "red", amount: 3,
  },
  "roster.dye_collect": { type: "roster.dye_collect", bucketId: "bucket-1" },
