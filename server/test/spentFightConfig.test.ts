...
describe("a spent fight config is released with the fight", () => {
  ...
  // Friend invasions (PvP) are not part of this fork — the routes and
  // server/src/v3/pvp.ts were removed with upstream's raid verifier
  // (see MERGE_REVIEW.md). Restore this case alongside them.
});
