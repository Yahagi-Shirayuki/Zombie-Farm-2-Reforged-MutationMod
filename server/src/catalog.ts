...
export const CROPS: Readonly<Record<string, CropEcon>> = {
  ...
  spinalch: { cost: 210, sell: 320, xp: 1, growMs: 86400000, level: 23 },
  malakale: { cost: 210, sell: 320, xp: 1, growMs: 86400000, level: 23 },
  blueberyl: { cost: 210, sell: 320, xp: 1, growMs: 86400000, level: 23 },
  diamint: { cost: 210, sell: 320, xp: 1, growMs: 86400000, level: 23 },
  oatnyx: { cost: 210, sell: 320, xp: 1, growMs: 86400000, level: 23 },
};
