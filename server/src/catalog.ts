...
export const CROPS: Readonly<Record<string, CropEcon>> = {
  // #region generated:CROPS
  // Source: public/assets/plants.json — regenerate with `npm run catalogs` (server/scripts/gen-catalogs.mjs) — do not hand-edit
  ...
  lima_beans: { cost: 120, sell: 191, xp: 6, growMs: 86400000, level: 20 },
  ...
  reddelicious: { cost: 125, sell: 175, xp: 1, growMs: 43200000, level: 6 },
  felonmelon: { cost: 165, sell: 218, xp: 1, growMs: 43200000, level: 7 },
  spinalch: { cost: 110, sell: 150, xp: 1, growMs: 43200000, level: 22 },
  malakale: { cost: 160, sell: 200, xp: 1, growMs: 43200000, level: 22 },
  blueberyl: { cost: 195, sell: 230, xp: 1, growMs: 86400000, level: 23 },
  oatnyx: { cost: 260, sell: 420, xp: 1, growMs: 129600000, level: 24 },
  diamint: { cost: 350, sell: 365, xp: 1, growMs: 2700000, level: 25 },
  // #endregion generated:CROPS
};
